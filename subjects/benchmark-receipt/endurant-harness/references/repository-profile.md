...
Put durable repository-specific guidance in `AGENTS.md`. When a separate machine-readable handoff is useful, save this template at the repository root as `.agents/endurant-harness-profile.md`; `scripts/endurant.py probe` loads it automatically.
