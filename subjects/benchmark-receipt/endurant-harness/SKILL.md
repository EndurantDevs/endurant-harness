...
Select proof by task: focused behavior; identical before/after synthetic workload plus correctness for performance/efficiency; affected scope when material; available local CI before remote CI; diff. Use comparator once per phase. Skip irrelevant synthetic work for ordinary tasks.
...
- Uncertain: one scan, change, and proof packet.
