...
For clear reversible work, allow two discovery commands: instructions/status/profile/symbol, then source/test. If uncertain/contradictory, escalate before production edit. Edit; run focused behavior, CI, and diff. Skip probe, hypothesis, analogy, checkpoint, JSON plan, subagent, and broad suites. Escalate for uncertainty, coupling, performance/efficiency, migrations, security, deployment, or material risk.
